...
const Cw2 = -0.0007503366623422131;

const Clw = 0.04664098613771486;

const Cl2 = 0.08855286031299997;
...
button.addEventListener('click',function(){
    ...
    .then(data => {
        ...
        var b = Clw*tempValue + Cl;

        var c = Ci + Cw*wea + Cw2*wea**2+int-desired_temp;
